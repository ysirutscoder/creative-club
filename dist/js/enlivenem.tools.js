/******************************************************************************************
 * @name:       enlivenem.tools.js - the third party libraries for Enliven 'em script
 * @version:    1.5
 ...
 * @note:       Due to the lost functionality in the latest versions of Snap.svg of the
 universal and ease to use transform strings like "t0,0s1,1r0", this
 version (0.3.0) will NOT be replaced.
 To prevent any conflicts with the newest versions of Snap (if used for
 OTHER projects) this Snap.svg is renamed and may be called as "Elvn_Snap"
 object, the eve is renamed and may be called as "Elvn_eve".
 *******************************************************************************************/
...
!function (a) {
  ...
  }, "undefined" != typeof module && module.exports ? module.exports = m : "function" == typeof define && define.amd ? define("Elvn_eve", [], function () {
    return m;
  }) : a.Elvn_eve = m;
}(this), function (a, b) {
  "function" == typeof define && define.amd ? define(["Elvn_eve"], function (c) {
    return b(a, c);
  }) : b(a, a.Elvn_eve);
}(this, function (a, b) {
  var c = function (b) {
    ...
    function d(a, b) {
      ...
      function g(a) {
        ...
        "function" != typeof e || e.length || (g = e, e = c.linear), a instanceof l && (g = a.callback, e = a.easing, d = a.dur, a = a.attr);var i,
            j,
            k,
            m,
            n = [],
    ...
    var d = Math.max,
      ...
      "function" != typeof f || f.length || (g = f, f = c.linear), d instanceof a._.Animation && (g = d.callback, f = d.easing, e = d.dur, d = d.attr);var h = arguments;if (a.is(d, "array") && a.is(h[h.length - 1], "array")) var i = !0;var j,
          k = function () {
        j ? this.b = j : j = this.b;
      },
          l = 0,
    ...
    function d(a) {
      ...
      var b,
        ...
        f += g + "]", i[b] = f;
      }return Function("val", "return Elvn_Snap.path.toString.call([" + i + "])");
    }function j(a) {
...
}(this, "Elvn_verge", function () {
  function a() {
    return { width: k(), height: l() };
  }function b(a, b) {
    var c = {};return b = +b || 0, c.width = (c.right = a.right + b) - (c.left = a.left - b), c.height = (c.bottom = a.bottom + b) - (c.top = a.top - b), c;
  }function c(a, c) {
    return a = a && !a.nodeType ? a[0] : a, a && 1 === a.nodeType ? b(a.getBoundingClientRect(), c) : !1;
  }function d(b) {
    b = null == b ? a() : 1 === b.nodeType ? c(b) : b;var d = b.height,
        e = b.width;return d = "function" == typeof d ? d.call(b) : d, e = "function" == typeof e ? e.call(b) : e, e / d;
  }var e = {},
    ...
    var a = h.clientWidth,
        b = f.innerWidth;return b > a ? b : a;
  },
      l = e.viewportH = function () {
    var a = h.clientHeight,
        b = f.innerHeight;return b > a ? b : a;
    ...
    var d = c(a, b);return !!d && d.right >= 0 && d.left <= k();
  }, e.inY = function (a, b) {
    var d = c(a, b);return !!d && d.bottom >= 0 && d.top <= l();
  }, e.inViewport = function (a, b) {
    var d = c(a, b);return !!d && d.bottom >= 0 && d.right >= 0 && d.top <= l() && d.left <= k();
  }, e;
});